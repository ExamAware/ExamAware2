...
**gyp-next** is [released](https://github.com/nodejs/gyp-next/releases) to the [**Python Packaging Index**](https://pypi.org/project/gyp-next) (PyPI) and can be installed with the command:

- `python3 -m pip install gyp-next`

When used as a command line utility, **gyp-next** can also be installed with [pipx](https://pypa.github.io/pipx):
