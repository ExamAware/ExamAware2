...
function runHello(hostProcess = process.execPath) {
  ...
  return execFileSync(hostProcess, ['--experimental-wasi-unstable-preview1', '-e', testCode], {
    cwd: __dirname
  });
}
