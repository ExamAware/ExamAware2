...
} from '../../../src/main/timeSync/timeConfig'
...
vi.mock('../../../src/main/timeSync/ntpClient', () => ({
...
describe('time service integration', () => {
  ...
  it('normalizes unified and legacy loaded values before applying offsets', async () => {
    ...
    let service = await import('../../../src/main/timeSync/timeService')
    ...
    service = await import('../../../src/main/timeSync/timeService')
  ...
  it('uses safe normalized interval delays for apply and save', async () => {
    ...
    const service = await import('../../../src/main/timeSync/timeService')
