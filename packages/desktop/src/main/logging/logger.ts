...
import { getConfig, patchConfig } from '../config/configStore'
import type { LoggingConfig, LogLevel } from '../../shared/types/desktop'

export type { LoggingConfig, LogLevel } from '../../shared/types/desktop'
